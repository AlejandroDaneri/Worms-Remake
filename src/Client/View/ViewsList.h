...
public:
	...
	void
	updateWormData(int id, int player_id, float pos_x, float pos_y, int life,
				   char dir, bool colliding);

	/* Actualiza la posicion del arma */
	void updateWeaponData(int id, const std::string& weapon_name, float pos_x,
						  float pos_y);
